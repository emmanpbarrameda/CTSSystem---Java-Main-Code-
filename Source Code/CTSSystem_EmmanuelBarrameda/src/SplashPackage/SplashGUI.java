...
public final class SplashGUI extends javax.swing.JFrame {
    ...
    public static ServerSocket cts_ServerSocketstatus;
    ...
    public SplashGUI() {
        ...
        SplashGUI.this.getRootPane().setBorder(new LineBorder(new Color(0, 102, 204), 2, false)); //<-- set border for this frame
    ...
    public void checkAppTaskStatus() throws IOException {
        cts_ServerSocketstatus = null;
        try {
            cts_ServerSocketstatus = new ServerSocket(1044);
        } catch (IOException e) {
    ...
    private void initComponents() {
        ...
        zabmeaning.setText("Clock, Timer and Stopwatch System");
        jPanel1.add(zabmeaning, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 410, -1));

        mainAnimatedIcon.setForeground(new java.awt.Color(0, 102, 204));
